...
//   // ジャンルの選択肢が変更された際の動作
//   // 駅カテゴリー 選別 取得
//   city_category = document.getElementById("city_category");

//   // getElementById()でidを取得
//   town_id = document.getElementById("town_id");
//   console.log("new.js読み込み完了")
...
//       {cd:"六町", label:"六町"}
//     ];
//   // 配列を繰り返し処理で回す。(value)には’Tosima’で選択された物が１つずつ入る
